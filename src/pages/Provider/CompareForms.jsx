  ...
  return (
    <div>
      ...
      <div className=" rounded-xl bg-white p-6">
        ...
        <HiOutlineDocumentMinus color="#6161FF" size={45} className=" bg-[#E5E5FF] rounded-xl p-2" />
       
       <div>
<h1 className=" text-2xl font-bold text-dark">Shipping Companies  Form</h1>
<p className="text-[#B7B7B7]">Please fill out this form if you want to get listed in Board Compare</p>
       </div>
        </div>
