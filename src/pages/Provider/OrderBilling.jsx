    ...
    <div className=" font-poppins">
      ...
      <div className=" p-8">
        <div className=" flex gap-2 items-center">
          <img src={user} className=" rounded-full w-[40px]"></img>
          <span className=" text-xl  font-medium text-dark">Mohamed Ahmed</span>
        </div>
        <div className=" font-poppins">
          <h1 className=" text-[#5E5E5E] font-[500] text-lg py-6 px-2">
            Billing Plan
          </h1>

          <div className=" lg:flex-row flex flex-col gap-8 ">
            <div className=" p-5 rounded-3xl border border-primary  relative ">
              <div className=" bg-primary text-white rounded-full absolute p-2 py-3 top-[-12px] right-[-12px] ">50%</div>
              <h3>Billed Yearly</h3>
              <h4 className=" text-light  text-xl py-3 text-primary">
              EGP 2,999
              </h4>
              <p className=" text-[#D6D6D6]  text-sm">Member per month</p>
            </div>

            <div className=" p-5 rounded-3xl border border-primary">
              <h3>Billed Yearly</h3>
              <h4 className=" text-light  text-xl py-3 text-primary poppins-thin">
                EGP 2,999
              </h4>
              <p className=" text-[#D6D6D6] text-sm">Member per month</p>
            </div>
      ...
      <div className=" border-[#00000040] border-t-[1px] mt-4">
    ...
    <div className="py-6">
      ...
      <ul className="p-8 flex flex-col gap-2">
        {features.map((item, index) => (
          <li
            key={index}
            className="grid grid-cols-[auto,1fr] py-1 gap-2 items-start text-sm"
          >
      ...
      <h2 className="text-xl by-6 text-center text-[#5E5E5E]">
        Tax fees excluded(14%)
      </h2>
      <h3 className="text-lg by-6 text-center text-[#5E5E5E]">
  ...
  return (
    <div className="bg-[#F5F6FA] flex items-center justify-center">
      <div>
        ...
        <div className="shadow-custom lg:w-[1100px] lg:h-[900px] bg-white rounded-3xl">
