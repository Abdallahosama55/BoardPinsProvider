...
const{t}=useTranslation()
  return (
    <div className="bg-white min-h-full p-6 rounded-xl flex justify-center items-center ">
    <div>
      <div className="flex w-full justify-center items-center">
        <div className="flex flex-col flex-wrap lg:flex-row items-center gap-6">
          ...
          {selectedItems?.map((item, index) => (
            <div className="flex items-center" key={`${index}`}>
              ...
              <div className="flex flex-col items-center relative">
                <div className="w-full flex justify-end px-6 absolute">
                  <FaMinus className="rounded-full border font-bold border-[#FFB8B8] bg-white p-1" size={20} color="#FFB8B8" />
                </div>
          ...
          {/* Display empty slots */}
          {Array.from({ length: 1 - selectedItems.length })?.map((_, index) => (
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  <div className="text-center text-xs text-gray-300 font-semibold flex flex-col items-center">
                    ...
                    <p className="w-[75%]">{t('comparison.choose')}</p>
                  </div>
                </div>
                <div className="mt-2 flex items-center gap-3">
      ...
      <div className="py-16 px-6 mt-12 bg-[#D9D9D921] rounded-xl text-xl text-[#CDCDCD]">
        <div className="lg:w-[80%]">
          {t('comparison.chooseServiceProvider')}
        </div>
