      ...
      <header className="flex flex-col lg:flex-row">
        ...
        {isbuttonApply ? (
          <div className="flex justify-end mt-5 lg:mt-1 items-center gap-2 px-5 lg:order-2 order-1">
            ...
            <div className="flex justify-end mt-5 lg:mt-1 items-center gap-2 px-5 lg:order-2 order-1">
            <button className={`${status==="Approved"? 'bg-[#45DD4B12] text-[#52CD8F] ':''} ${status==="Rejected"? 'bg-[#FF141412] text-[#FF1414] ':''} ${status==="Pending"? 'bg-[#40404012] text-[#404040] ':''} flex items-center gap-1 rounded-2xl text-center px-4 py-2`}>
