...
const ProjectDescription = ({openAttachmentModal}) => (
  <div className="border border-[#0000001A] bg-[#FBFBFF] rounded-2xl p-4">
    ...
    <h2 className="font-bold text-[#6161FF]">Lorem ipsum dolor sit amet consectetur</h2>
    ...
    <p className="font-medium text-red-400">
      ...
      <span className="underline cursor-pointer text-primary">See an example</span>
    </p>
    <div>
      <h5 className="text-dark font-medium text-[16px] py-5">Attachments</h5>
      <div className="text-sm flex items-center gap-4">
        <AttachmentButton icon={<RiAttachment2 />} label="Attachments" openAttachmentModal={openAttachmentModal} />
      ...
      <div className="flex items-start gap-2 py-3">
        ...
        <div>
          ...
          <div className="flex gap-2 text-xs">
            <ProposalInfo icon={<MdWorkOutline />} label="Software engineer" />
            <ProposalInfo icon={<BsClock />} label="Software engineer" />
          </div>
        </div>
      </div>
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-3 bg-[#F2F2F2] p-4">
        <ProposalDetail icon={<HiOutlineCurrencyDollar />} label="500 Egp" subLabel="Provided Price" />
        <ProposalDetail icon={<HiOutlineCurrencyDollar />} label="500 Egp" subLabel="Provided Price" />
        <ProposalDetail icon={<HiOutlineCurrencyDollar />} label="4 Days" subLabel="From 15-6-2025" extraSubLabel="Dead line" />
      </div>
      <p className="text-sm text-gray-400 font-poppins p-4">
        Peace be upon you. Hello, Mr. Omar. You are now available to begin immediately designing your identity. I read the description carefully and I promise to provide you with a professional and attractive official design, as the identity reflects the company’s image...
      </p>
