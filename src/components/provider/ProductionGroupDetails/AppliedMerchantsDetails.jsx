...
const merchants = [
  { name: "Mohamed Adel", rating: 4, role: "Software Engineer", timeAgo: "2 hours ago" },
  { name: "Mohamed Farg", rating: 4, role: "Software Engineer", timeAgo: "2 hours ago" },
  { name: "Mohamed Kareem", rating: 4, role: "Test Engineer", timeAgo: "2 hours ago" },
];
  ...
  return (
    <header className="py-5 grid grid-cols-12 items-center gap-2 flex-row relative">
      <div className="col-span-12 md:col-span-5 flex items-center gap-2">
        ...
        />
        <h3 className="text-sm text-gray-700 px-3">{t('select_all')}</h3>
      </div>
  ...
  return (
    <div className="col-span-12 md:col-span-4 flex items-center gap-3 mt-3 md:mt-0">
      <div className="font-medium text-sm text-[#6161FF]">
        {t('create_project_with_merchant')}
      </div>
...
function AppliedMerchantsDetails() {
  const [selectedMerchants, setSelectedMerchants] = useState(merchants?.map(() => false));
