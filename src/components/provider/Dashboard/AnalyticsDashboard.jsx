...
const PerformanceOverview = ({ title}) => (
  <div className="mt-5 shadow-custom rounded-lg p-4 mb-3">
    ...
    <div className="grid items-center justify-center grid-cols-12 sm:grid-cols-12 lg:grid-cols-12 gap-2 py-5  gap-4">
     <div className=' lg:col-span-3 col-span-11  flex items-center justify-center bg-gray-100 rounded-xl  '>
    <div>
...
const ProductionGroups = ({ items }) => (
  ...
  const   AnalyticsChart = () => (
    <div className="  shadow-custom p-4 rounded-lg ">
      ...
      <button className="bg-[#6161FF] rounded-2xl px-5 py-2 text-white mb-2 sm:mb-0 sm:ml-4">
      Merchants
      </button>
      {/* Annual Target Button */}
      <button className="text-[#6161FF] rounded-lg px-5 py-2">
      Projects
      </button>
